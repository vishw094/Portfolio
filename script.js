(function () {
  ...
  // Visit notification: email you when someone views the site (with their location from IP)
  (function () {
    ...
    fetch("https://ipapi.co/json/")
      ...
      .then(function (data) { sendVisit(data); })
      .catch(function () {
        sendVisit({ ip: "unknown", country_name: "Unknown" });
      });
  })();
})();
